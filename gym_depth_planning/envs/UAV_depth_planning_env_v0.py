...
class UAVDepthPlanningEnv_v0(gym.Env):
    ...
    def __init__(self, no_dynamics=False, discrete_actions=False):
        ...
        self.ros_srv_touch_sensor_collision_enable = rospy.ServiceProxy("/" + self.model_name + "/touch_sensor_collision/enable", webots_ros.srv.set_int)
        self.ros_srv_touch_sensor_safety1_enable = rospy.ServiceProxy("/" + self.model_name + "/touch_sensor_safety1/enable", webots_ros.srv.set_int)
        self.ros_srv_touch_sensor_safety2_enable = rospy.ServiceProxy("/" + self.model_name + "/touch_sensor_safety2/enable", webots_ros.srv.set_int)
        self.ros_srv_range_sensor_enable = rospy.ServiceProxy("/" + self.model_name + "/range_finder/enable", webots_ros.srv.set_int)
        self.ros_srv_laser_sensor_enable = rospy.ServiceProxy("/" + self.model_name + "/lidar/enable", webots_ros.srv.set_int)
        try:
        ...
        if no_dynamics:
            self.ros_srv_gps1_sensor_enable = rospy.ServiceProxy("/" + self.model_name + "/gps1/enable", webots_ros.srv.set_int)
            self.ros_srv_inertial_unit_enable = rospy.ServiceProxy("/" + self.model_name + "/inertial_unit/enable", webots_ros.srv.set_int)
            self.ros_srv_get_self = rospy.ServiceProxy("/" + self.model_name + "/supervisor/get_self", webots_ros.srv.get_uint64)
            self.ros_srv_get_field = rospy.ServiceProxy("/" + self.model_name + "/supervisor/node/get_field", webots_ros.srv.node_get_field)
            self.ros_srv_field_set_v3 = rospy.ServiceProxy("/" + self.model_name + "/supervisor/field/set_vec3f", webots_ros.srv.field_set_vec3f)
            self.ros_srv_field_set_rotation = rospy.ServiceProxy("/" + self.model_name + "/supervisor/field/set_rotation", webots_ros.srv.field_set_rotation)
            ...
            print("robot id, field-t and field-r:", self.robot_node_id, self.robot_translation_field, self.robot_rotation_field)
