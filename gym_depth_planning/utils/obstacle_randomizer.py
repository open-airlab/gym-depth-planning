...
class ObstacleRandomizer():
    def __init__(self, model_name):
        ...
        try:
            ...
            print(node for node in self.wall_nodes)
            self.wall_translation_fields = [self.ros_srv_get_field(node, 'translation', False).field for node in self.wall_nodes]
        except rospy.ServiceException as exc:
            print("Service did not process request: " + str(exc))
    ...
    def randomize_environment(self, with_walls=None, number_of_obstacles=None, save_config_dir=None):
        ...
        # print(number_of_cylinders, number_of_boxs, number_of_spheres)
    ...
    def reload_environment(self, load_dir):
        ...
        # print(conf)
        # print(conf["with_walls"], conf["wall_width"])
        self.randomize_walls(with_walls=conf["with_walls"], lower_width=conf["wall_width"], higher_width=conf["wall_width"])
        # set cylinders
...
if __name__ == "__main__":
    randomizer = ObstacleRandomizer("quad_plus_sitl_3641_tensorbook")
